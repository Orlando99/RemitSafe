...
export default class TermsAndConditions extends Component {
    ...
    render() {
        ...
        return (
            <Modal
                trigger={this.props.fromFooter ? <a className="termcondition" onClick={this.props.handleOpen}>Terms and conditions</a> : <Checkbox
                    onClick={this.props.handleOpen}
                    label='I agree to the terms and conditions'
                    ref='terms'
                    checked={this.props.checked}
                    className='termsUnderline'
                />}
                ...
                <Modal.Header style={{ background: 'linear-gradient(2deg, rgba(196, 205, 229, 0.1), rgba(206, 221, 246, 0.1), rgba(220, 236, 255, 0.1))' }}>
                    ...
                    <Button className="closeTermsTopButton" onClick={this.props.handleClose}>
                            <Icon name='close' className="CloseTermsIcon" />
                    </Button>
